 ...
 * the License.
 */
package com.wm.mybatis.plus.generator.engine;
...
import com.wm.mybatis.plus.generator.config.TemplateConfig;
...
import com.wm.mybatis.plus.generator.config.rules.FileType;
...
public abstract class AbstractTemplateEngine {
    ...
    public AbstractTemplateEngine batchOutput() {
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                // Dao.java
                if (null != tableInfo.getServiceName() && null != pathInfo.get(ConstVal.DAO_PATH)) {
                    String serviceFile = String.format((pathInfo.get(ConstVal.DAO_PATH) + File.separator + tableInfo.getServiceName() + suffixJavaOrKt()), entityName);
                    if (isCreate(FileType.DAO, serviceFile)) {
                        writerFile(objectMap, templateFilePath(template.getDao()), serviceFile);
                    }
                }
                // IMpService.java
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        objectMap.put("superDaoClass", getSuperClassName(config.getStrategyConfig().getSuperDaoClass()));
