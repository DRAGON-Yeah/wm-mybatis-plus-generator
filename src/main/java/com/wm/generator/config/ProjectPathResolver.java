...
import com.wm.generator.util.OSUtil;
...
import static com.wm.generator.dto.Constant.PACKAGE_JAVA_PREFIX;
import static com.wm.generator.dto.Constant.PACKAGE_RESOURCES_PREFIX;
...
public class ProjectPathResolver {
    ...
    public String resolveDaoPackage() {
        return PathUtil.joinPackage(basePackage, "dao");
    }
